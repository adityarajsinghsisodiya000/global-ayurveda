...
export default function BrandLogo({ size = 'medium', lightMode = false }) {
  const isSmall = size === 'small';
  
  return (
    <div className="flex items-center gap-3 group cursor-pointer">
      {/* Gold Lotus Leaf Icon */}
      <div className="relative flex-shrink-0">
        ...
        >
          ...
          {/* Central Lotus / Ayurveda Leaves */}
          {/* Center Main Leaf */}
          <path
            d="M 50 20 C 38 40 45 65 50 72 C 55 65 62 40 50 20 Z"
          ...
          {/* Left Main Leaf */}
          <path
            d="M 50 35 C 30 45 28 65 34 70 C 42 68 48 55 50 35 Z"
            fill="url(#goldGradient)"
            opacity="0.9"
          />
          {/* Right Main Leaf */}
          <path
            d="M 50 35 C 70 45 72 65 66 70 C 58 68 52 55 50 35 Z"
            fill="url(#goldGradient)"
            opacity="0.9"
          />
          {/* Outer Left Leaf */}
          <path
            d="M 45 50 C 22 55 18 70 24 73 C 32 72 40 62 45 50 Z"
            fill="url(#goldGradient)"
            opacity="0.75"
          />
          {/* Outer Right Leaf */}
          <path
            d="M 55 50 C 78 55 82 70 76 73 C 68 72 60 62 55 50 Z"
            fill="url(#goldGradient)"
            opacity="0.75"
          />
